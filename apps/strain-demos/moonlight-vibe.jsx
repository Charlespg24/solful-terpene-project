        ...
        <div style={{ padding: "0 28px 36px" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 14 }}>
              <div style={{ fontFamily: THEME.monoFont, fontSize: 9, letterSpacing: 2, color: THEME.gold, textTransform: "uppercase" }}>ISO Principle</div>
              <div style={{ fontFamily: THEME.monoFont, fontSize: 10, color: THEME.textDim }}>Energy 0.25 · Valence 0.55</div>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 14 }}>
              {[
                { phase: "Settle", bpm: "74", mins: "10" },
                { phase: "Immerse", bpm: "69", mins: "15" },
                { phase: "Emerge", bpm: "84", mins: "5" },
              ].map(p => (
                <div key={p.phase} style={{ padding: "10px 10px", background: THEME.bgPanel, borderRadius: 8, border: `1px solid ${THEME.border}`, textAlign: "center" }}>
                  <div style={{ fontFamily: THEME.monoFont, fontSize: 9, color: THEME.textDim, letterSpacing: 1, textTransform: "uppercase", marginBottom: 4 }}>{p.phase}</div>
                  <div style={{ fontFamily: THEME.displayFont, fontSize: 22, color: THEME.accent2, lineHeight: 1 }}>{p.bpm}</div>
                  <div style={{ fontFamily: THEME.monoFont, fontSize: 9, color: THEME.textDim, marginTop: 2 }}>BPM · {p.mins}min</div>
                </div>
              ))}
            </div>
            <div style={{ fontFamily: THEME.bodyFont, fontSize: 12, color: THEME.textDim, lineHeight: 1.6, fontStyle: "italic" }}>
