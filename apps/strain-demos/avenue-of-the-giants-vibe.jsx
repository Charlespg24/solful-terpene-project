...
const LIGHT_RAYS = [
  { left: 8, rotate: 18, width: 90, delay: 0, dur: 12 },
  { left: 25, rotate: 22, width: 70, delay: 3, dur: 15 },
  { left: 45, rotate: 16, width: 110, delay: 6, dur: 10 },
  { left: 62, rotate: 20, width: 80, delay: 1.5, dur: 14 },
  { left: 80, rotate: 24, width: 95, delay: 4.5, dur: 13 },
];
...
export default function AvenueOfTheGiantsVibe() {
  return (
    <div style={{
      ...
      {/* Falling light rays through redwood canopy */}
      <svg style={{
        ...
        <defs>
          <linearGradient id="rayGreen" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#6AC87A" stopOpacity="0.35" />
            <stop offset="40%" stopColor="#6AC87A" stopOpacity="0.15" />
            <stop offset="100%" stopColor="#6AC87A" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="rayGold" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#E8B878" stopOpacity="0.3" />
            <stop offset="40%" stopColor="#E8B878" stopOpacity="0.12" />
            <stop offset="100%" stopColor="#E8B878" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="rayGreenSoft" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#4EA860" stopOpacity="0.25" />
            <stop offset="50%" stopColor="#4EA860" stopOpacity="0.08" />
            <stop offset="100%" stopColor="#4EA860" stopOpacity="0" />
          </linearGradient>
        </defs>
        {LIGHT_RAYS.map((r, i) => (
          <g key={i} transform={`translate(${r.left}, 0) rotate(${r.rotate})`}
             style={{
            ...
            <polygon
              ...
              fill={i % 3 === 0 ? "url(#rayGold)" : i % 3 === 1 ? "url(#rayGreen)" : "url(#rayGreenSoft)"}
            />
          </g>
        ))}
      </svg>
